...
public class TreasuryYieldXMLConfig extends MongoTool {
    ...
    public TreasuryYieldXMLConfig(final Configuration conf) {
        ...
        MongoConfigUtil.setInputURI(conf, "mongodb://localhost:27017/mongo_hadoop.yield_historical.in");
        MongoConfigUtil.setOutputURI(conf, "mongodb://localhost:27017/mongo_hadoop.yield_historical.out");
    ...
    public static void main(final String[] pArgs) throws Exception {
    	System.out.println("Run TreasuryYieldXMLConfig");
